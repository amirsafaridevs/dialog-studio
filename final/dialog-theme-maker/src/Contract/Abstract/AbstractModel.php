...
namespace DialogStudio\Contract\Abstract;

if ( ! defined( 'ABSPATH' ) ) {
    exit;
}

use DialogStudio\Contract\Interface\ModelInterface;
use DialogStudio\Core\Application;
use DialogStudio\Core\DB;
use DialogStudio\Core\Database\ModelQueryBuilder;
use DialogStudio\Core\Database\Paginator;
 ...
 * Full table name = application prefix + '_' + TABLE (e.g. DialogStudio_logs). WordPress prefix (wp_) is applied by QueryBuilder.
 */
abstract class AbstractModel implements ModelInterface
{
     ...
     *
     * @return \DialogStudio\Core\Database\QueryBuilder
     */
    public static function newQuery(): \DialogStudio\Core\Database\QueryBuilder
    {
