...
{
    private const MU_PLUGIN_FILENAME   = 'dialog-studio.php';
    ...
    public function activate(): void
    {
        ...
        if ( $this->getApplication()->getContainer()->bound( 'dialog.runtime' ) ) {
            $this->getApplication()->getContainer()->get( 'dialog.runtime' )->activate();
        }
    }
