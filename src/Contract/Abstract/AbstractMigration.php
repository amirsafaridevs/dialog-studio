 ...
 * Use getTableName('suffix') to get the table name with application prefix (e.g. DialogStudio_logs).
 *
...
abstract class AbstractMigration implements MigrationInterface
{
    ...
    /**
     * Get full table name with application prefix (e.g. 'logs' → 'DialogStudio_logs').
