...
use DialogStudio\Contract\Interface\RepositoryInterface;
use DialogStudio\Core\DB;
use DialogStudio\Core\Database\QueryBuilder;
use DialogStudio\Core\Database\RepositoryQueryBuilder;
...
{
    /**
     * Model class name (e.g. DialogStudio\Model\Chat::class). Must be defined in subclass.
     *
