...
use DialogStudio\Core\Database\SchemaBuilder;
...
class DB
{
     ...
     *
     * @param string $table Table name with or without WordPress prefix (e.g. DialogStudio_chats or wp_DialogStudio_chats).
